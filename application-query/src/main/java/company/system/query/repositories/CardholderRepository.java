...
public class CardholderRepository {
    ...
    public List<CardholderDTO> getAllUsers() {
        ...
        return entityManager.unwrap(Session.class)
                .createNativeQuery("SELECT id, full_name, email, document, type, active FROM cardholder", CardholderDTO.class)
    ...
    public CardholderDTO getUserById(Long id) {
        ...
        return entityManager.unwrap(Session.class)
                .createNativeQuery("SELECT id, full_name, email, document, type, active FROM cardholder where id = :id", CardholderDTO.class)
                .setParameter("id", id)
                .setTupleTransformer(new CardholderDTO()::transformTuple)
                .getSingleResult();
    }
